    ...
    <View style={styles.screenContainer}>
      <View style={[styles.container, styles.border]}>
        <View style={styles.profileContainer}>
          <Image
            source={{ uri: 'https://avatars.githubusercontent.com/u/163747740?s=400&u=b0755428e981a9559263f2dc9222c540461a2463&v=4' }} // Ganti dengan URL gambar kamu
            style={styles.profileImage}
          />
          <Text style={styles.title}>Fikry Aiman Munadhil</Text>
        </View>
        <Text style={styles.text}>NIM: 222505036</Text>
      </View>
...
const AboutMeScreen = () => (
  <View style={styles.screenContainer}>
    <View style={[styles.container, styles.border]}>
      ...
      <Text style={styles.text}>Saya adalah seorang mahasiswa tingkat 5 di Universitas Ma'soem 
        yang sedang belajar React Native.</Text>
    </View>
  </View>
);
...
const HobbiesScreen = () => (
  <View style={styles.screenContainer}>
    <View style={[styles.container, styles.border]}>
      ...
      <Text style={styles.text}>1. Futsal</Text>
...
const CustomDrawerContent = (props: DrawerContentComponentProps) => (
  <View style={{ flex: 1 }}>
    ...
    <View style={styles.drawerProfileContainer}>
      ...
      />
      <Text style={styles.drawerTitle}>Fikry Aiman M</Text>
    </View>
